    ...
    public List<string> phase2Lines = new List<string>
{
    ...
    "fight the lord battles ", 
        "with the undefeated army of the angels",
    "as once thou didst fight the first apostate and he prevailed not",
    "where the sea of peter has been settled ", 
        " for the light of the gentiles",
    "where the behemoth was cast out the serpent ", 
        " called the devil seduced the world",
    "pray the god of peace to crush satan ", 
        " may he no more be able to harm innocents amen"
};
